...
Button(root,text='=',width=5,height=3, font=('arial',30,'bold'), bd=1,fg='#fff',bg='orange', command=lambda:caculate()).place(x=430,y=400)

Button(root,text='0',width=10,height=1, font=('arial',30,'bold'), bd=1,fg='#fff',bg='#2a2d36', command=lambda: show('0')).place(x=10,y=500)
Button(root,text='.',width=5,height=1, font=('arial',30,'bold'), bd=1,fg='#fff',bg='#2a2d36', command=lambda: show('.')).place(x=280,y=500)
root.mainloop()